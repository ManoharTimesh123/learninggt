...
$string['recordingdetails'] = 'Details';
$string['editingbuttons'] = 'Action';
...
$string['host'] = 'Host';
$string['hostmeetinglink'] = '<a href="{$a->url}" target="_blank">Host Meeting</a>';
$string['hostschedulingexception'] = 'User cannot scheduling a meeting for this host.';
$string['inprogress'] = 'In progress';
$string['invalidtype'] = 'Invalid type';
$string['joinmeetinglink'] = '<a href="{$a->url}" onclick="studentattendence({$a->course}, {$a->user}, {$a->cmid})">Join Meeting</a>';
