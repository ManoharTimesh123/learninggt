...
// Retrieve user enrollment information in the course
...
if (($enrollment->status == ENROL_USER_SUSPENDED) && !$canmanage) {
    require_login();
} else {
...
if (!$downloadown && !$downloadissue && ($enrollment->status != ENROL_USER_SUSPENDED || $canmanage)) {
