...
class template {
    ...
    */
     ...
     */
    public function generate_images(bool $preview = false, int $userid = null, bool $return = false, int $certficateid = 0) {
        global $CFG, $DB, $USER;
        ...
        if ($pages = $DB->get_records('customcert_pages', array('templateid' => $this->id), 'sequence ASC')) {
            ...
            $imageFilename = pathinfo($filename, PATHINFO_FILENAME) . $certficateid . 'id' . $USER->id . '.png';
