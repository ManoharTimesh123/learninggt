...
class coursereport_table extends table_sql {
    ...
    function __construct($uniqueid) {
        ...
        $columns = array('num', 'firstname', 'lastname', 'coursename', 'moduleid', 'instanceid', 'timemodified');
        $this->define_columns($columns);

        // Define the titles of columns to show in header.
        $headers = array('S No.', 'Firstname', 'Lastname', 'Course', 'Activity', 'Name', 'CompletionTime');
