...
function render_coursedetail($courselimit, $showviewall = true) {
    ...
    // $table->width = '100%';
    $table->head = ['Course Name', 'No. of Enrolled Users','Course Hits By Week', 'Course Access Progress', 'Average Course Completion'];
    ...
    foreach ($coursedetails as $coursedetail) {
        ...
        $hitsparams = ['id' => $coursedetail['courseid']];
        $hiturl = new moodle_url('/blocks/analytics_graphs/hits.php', $hitsparams);
        ...
        $list[] = '<p class="status Analytics"><a href = "' . $hiturl. '"> View Hits </a></p>';
